...
Instead, the application and benchmark programs used in the evaluation will decide the resource
needs. Moreover, the nature of the research requires us to run different benchmarks and in different
...
properly evaluate the performance. All of these making the estimation of the required
...
and benchmarks such as CORAL benchmark codes would take more computing hours. 
